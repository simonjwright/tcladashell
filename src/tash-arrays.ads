...
package Tash.Arrays is
   ...
   function To_Tash_Array (
      Str  : in String) return Tash_Array;
...
--      TArray   : in Tash_Array) return Tash_Array;
   ...
   function To_String (
      TArray : in Tash_Array) return String;
   ...
   function Length (
      TArray : in Tash_Array) return Natural;
   ...
   function Get_Element (
      TArray : in Tash_Array;
      Index  : in String) return String;

   function Get_Element (
      TArray : in Tash_Array;
      Index  : in String) return Tash.Lists.Tash_List;
   ...
   function Exists (
      TArray : in Tash_Array;
      Index  : in String) return Boolean;
   ...
   function Get_Elements (
      TArray  : in Tash_Array;
      Pattern : in String := "") return Tash.Lists.Tash_List;
