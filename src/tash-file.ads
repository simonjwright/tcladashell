...
package Tash.File is
   ...
   function Get_Attribute (
      Name : in String;
      Attr : in Attribute) return String;
   ...
   procedure Cd               (Name : in String := "")
         renames Change_Directory;
   ...
   function Match (
      ...
      Type_List      : in String := "") return Tash.Lists.Tash_List;
   function Glob (
      Pattern        : in String;
      Directory      : in String := "";
      Path_Prefix    : in String := "";
   ...
   function Pwd                       return String
         renames Current_Working_Directory;
