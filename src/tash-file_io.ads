...
package Tash.File_IO is
   ...
   function EOF         (File : in Tash_File) return Boolean
      renames End_Of_File;
   ...
   function Get_Blocking_Mode (
      File : in Tash_File) return Boolean;
   ...
   function Get_Buffering_Mode (
      File : in Tash_File) return Buffering_Mode;
   ...
   function Get_Buffer_Size (
      File : in Tash_File) return Buffer_Size;
   ...
   function Get_EOF_Char (
      File : in Tash_File) return Character;
   function Get_EOF_Char (
   ...
   function Get_Translation_Mode (
      File : in Tash_File) return Translation_Mode;
