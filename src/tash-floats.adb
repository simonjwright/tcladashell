...
package body Tash.Floats is
   ...
   function Is_Zero (
      TFloat : in Tash_Float) return Boolean is
   begin -- Is_Zero
      return Is_Null (TFloat) or else To_Float (TFloat) = 0.0;
   end Is_Zero;
   pragma Inline (Is_Zero);

   function To_Tash_Float (
      Str : in String) return Tash_Float is
   --
      New_Obj : Tcl.Tcl_Obj;
   begin -- To_Tash_Float
   ...
   function To_String (
      TFloat : in Tash_Float) return String is
   --
   ...
   function To_Tash_Float (
      LFloat : in Tash_Float_Range) return Tash_Float is
   --
      New_Obj : Tcl.Tcl_Obj;
   begin -- To_Tash_Float
   ...
   function To_Float (
      TFloat : in Tash_Float) return Tash_Float_Range is
   --
   ...
   function "=" (
      Left  : in Tash_Float;
      Right : in Tash_Float) return Boolean is
   begin -- "="
   ...
   function "=" (
      Left  : in Tash_Float;
      Right : in Tash_Float_Range) return Boolean is
   begin -- "="
   ...
   begin -- "abs"
      return To_Tash_Float (
         Standard."abs" (To_Float (Right)));
   end "abs";

   function "+" (
      Left  : in Tash_Float;
      Right : in Tash_Float) return Tash_Float is
   begin -- "+"
      return To_Tash_Float (
   ...
   function "+" (
      Left  : in Tash_Float;
      Right : in Tash_Float_Range) return Tash_Float is
   begin -- "+"
      return To_Tash_Float (
         Standard."+" (To_Float (Left), Right));
   end "+";
   ...
   function "**" (
      Left  : in Tash_Float;
      Right : in Integer) return Tash_Float is
   begin -- "**"
      return To_Tash_Float (
         Standard."**" (To_Float (Left), Right));
   end "**";
