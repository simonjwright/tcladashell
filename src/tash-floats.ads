...
package Tash.Floats is
   ...
   function To_Tash_Float (
      Str : in String) return Tash_Float;
   ...
   function To_String (
      TFloat : in Tash_Float) return String;
   ...
   function To_Tash_Float (
      LFloat : in Tash_Float_Range) return Tash_Float;
   ...
   function To_Float (
      TFloat : in Tash_Float) return Tash_Float_Range;
   ...
   function "=" (
      Left  : in Tash_Float;
      Right : in Tash_Float) return Boolean;

   function "=" (
      Left  : in Tash_Float;
      Right : in Tash_Float_Range) return Boolean;
   ...
   function "+" (
      Left  : in Tash_Float;
      Right : in Tash_Float) return Tash_Float;

   function "+" (
      Left  : in Tash_Float;
      Right : in Tash_Float_Range) return Tash_Float;
   ...
   function "**" (
      Left  : in Tash_Float;
      Right : in Integer) return Tash_Float;
