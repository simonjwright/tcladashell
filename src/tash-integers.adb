...
package body Tash.Integers is
   ...
   function Is_Zero (
      TInteger : in Tash_Integer) return Boolean is
   begin -- Is_Zero
   ...
   function To_Tash_Integer (
      Str : in String) return Tash_Integer is
   --
      New_Obj : Tcl.Tcl_Obj;
   ...
   function To_String (
      TInteger : in Tash_Integer) return String is
   --
   ...
   function To_Tash_Integer (
      LInteger : in Tash_Integer_Range) return Tash_Integer is
   --
      New_Obj : Tcl.Tcl_Obj;
   begin -- To_Tash_Integer
   ...
   function To_Integer (
      TInteger : in Tash_Integer) return Tash_Integer_Range is
   --
   ...
   function "=" (
      ...
      Right : in Tash_Integer) return Boolean is
   begin -- "="
   ...
   function "=" (
      Left  : in Tash_Integer;
      Right : in Tash_Integer_Range) return Boolean is
   begin -- "="
   ...
   function "abs" (
      Right : in Tash_Integer) return Tash_Integer is
   begin -- "abs"
      return To_Tash_Integer (
         Standard."abs" (To_Integer (Right)));
   end "abs";
   ...
   function "+" (
      Left  : in Tash_Integer;
      Right : in Tash_Integer_Range) return Tash_Integer is
   begin -- "+"
      return To_Tash_Integer (
         Standard."+" (To_Integer (Left), Right));
   end "+";
   ...
   begin -- "+"
      return To_Tash_Integer (
         Standard."+" (Left, To_Integer (Right)));
   end "+";
   ...
   begin -- "rem"
      return To_Tash_Integer (
         Standard."rem" (To_Integer (Left), Right));
   end "rem";
   ...
   begin -- "rem"
      return To_Tash_Integer (
         Standard."rem" (Left, To_Integer (Right)));
   end "rem";
   ...
   begin -- "mod"
      return To_Tash_Integer (
         Standard."mod" (To_Integer (Left), Right));
   end "mod";
   ...
   begin -- "mod"
      return To_Tash_Integer (
         Standard."mod" (Left, To_Integer (Right)));
   end "mod";

   function "**" (
      Left  : in Tash_Integer;
      Right : in Natural) return Tash_Integer is
   begin -- "**"
      return To_Tash_Integer (
         Standard."**" (To_Integer (Left), Right));
   end "**";
