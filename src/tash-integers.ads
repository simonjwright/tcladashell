...
package Tash.Integers is
   ...
   function To_Tash_Integer (
      Str : in String) return Tash_Integer;
   ...
   function To_String (
      TInteger : in Tash_Integer) return String;
   ...
   function To_Tash_Integer (
      LInteger : in Tash_Integer_Range) return Tash_Integer;
   ...
   function To_Integer (
      TInteger : in Tash_Integer) return Tash_Integer_Range;
   ...
   function "=" (
      ...
      Right : in Tash_Integer) return Boolean;

   function "=" (
      Left  : in Tash_Integer;
      Right : in Tash_Integer_Range) return Boolean;
   ...
   function "abs" (
      Right : in Tash_Integer) return Tash_Integer;
   ...
   function "+" (
      Left  : in Tash_Integer;
      Right : in Tash_Integer_Range) return Tash_Integer;
   ...
   function "**" (
      Left  : in Tash_Integer;
      Right : in Natural) return Tash_Integer;
