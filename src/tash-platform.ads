--------------------------------------------------------------------
--
--  Unit Name:    Tash.Platform spec
--
--  File Name:    tash-platform.ads
--
...
package Tash.Platform is

   function Byte_Order return String;
   function Machine return String;
   function OS return String;
