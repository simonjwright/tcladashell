...
package Tash.Strings is
   ...
   function Is_Empty (
      TString : in Tash_String) return Boolean;
   ...
   function To_Tash_String (
      Str : in String) return Tash_String;
   ...
   function To_String (
      TString : in Tash_String) return String;
   ...
   function Length (
      TString : in Tash_String) return Natural;
   ...
   function "&" (
      Left  : in Tash_String;
      Right : in Tash_String) return Tash_String;

   function "&" (
      Left  : in Tash_String;
                 Right : String) return Tash_String;
   ...
   function "=" (
      Left  : in Tash_String;
      Right : in Tash_String) return Boolean;
   ...
   function Count (
      TString : in Tash_String;
      Set     : in Ada.Strings.Maps.Character_Set) return Natural;
   ...
   function Translate (
      TString  : in Tash_String;
      Mapping : in Ada.Strings.Maps.Character_Mapping) return Tash_String;
   ...
   function Replace_Slice (
      ...
      Low     : in Positive;
      High    : in Natural;
      By      : in String) return Tash_String;
   ...
   function Insert (
      TString  : in Tash_String;
      Before   : in Positive;
      New_Item : in String) return Tash_String;
   ...
   function Delete (
      TString : in Tash_String;
      From    : in Positive;
      Through : in Natural) return Tash_String;
   ...
   function Trim (
      TString : in Tash_String;
      Side    : in Ada.Strings.Trim_End) return Tash_String;
   ...
   function Trim (
      ...
      Right   : in Ada.Strings.Maps.Character_Set) return Tash_String;
   ...
   function Head (
      TString : in Tash_String;
      Count   : in Natural;
      Pad     : in Character := Ada.Strings.Space) return Tash_String;
   ...
   function "*" (
      Left  : in Natural;
      Right : in Character) return Tash_String;

   function "*" (
      Left  : in Natural;
      Right : in String) return Tash_String;
