...
--      end if;
   ...
   protected body Tash_Interp is
      ...
      procedure Assert (
         ...
         E           : in Ada.Exceptions.Exception_ID) is
      begin -- Assert
   ...
   function Type_Of (
      TObject : in Tash_Object'Class) return String is
   begin -- Type_Of
   ...
   function Ref_Count (
      TObject : in Tash_Object'Class) return Natural is
   begin -- Ref_Count
   ...
   function Image (
      TObject : in Tcl.Tcl_Obj) return String is
   --
   ...
   function Image (
      Num : in Integer) return String is
   begin -- Image
   ...
   function Image (
      Num : in Interfaces.C.Int) return String is
   begin -- Image
      return Ada.Strings.Fixed.Trim (
...
begin -- Tash
   ...
   begin
      ...
      if Tcl.Tcl_Init (Local_Interp) = Tcl.TCL_ERROR then
         Ada.Text_IO.Put_Line (Command_Name & ": Tcl_Init failed: " &
