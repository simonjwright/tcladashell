...
package Tash is
   ...
   function Is_Null (
      TObject : in Tash_Object) return Boolean;
   ...
   function To_String (
      TObject : in Tash_Object) return String is abstract;
