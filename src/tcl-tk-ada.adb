...
package body Tcl.Tk.Ada is
   ...
   procedure Bind (
      ...
      Script   : in String) is
   begin -- Bind
      Tcl_Eval (Widgt.Interp,
      	 "bind " & Widget_Image (Widgt) & " " & Sequence & " " & Script);
   end Bind;

   procedure Bind (
      Widgt    : in Widget'class;
      Sequence : in String) is
   begin -- Bind
      Tcl_Eval (Widgt.Interp,
   ...
   function Create (
      pathName : in String;
      options  : in String := "") return Frame is
   begin -- Create
   ...
   function Get_Main_Window (
      Interp : in Tcl_Interp) return Frame is
   --
   ...
   function Create (
      pathName : in String;
      options  : in String := "") return Toplevel is
   begin -- Create
      return Create (Context, pathName, options);
   end Create;
   ...
   function Create (
      pathName : in String;
      options  : in String := "") return Label is
   begin -- Create
      return Create (Context, pathName, options);
   end Create;
   ...
   function Create (
      pathName : in String;
      options  : in String := "") return Message is
   begin -- Create
      return Create (Context, pathName, options);
   end Create;
   ...
   function Create (
      pathName : in String;
      options  : in String := "") return Button is
   begin -- Create
      return Create (Context, pathName, options);
   end Create;
   ...
   function Create (
      pathName : in String;
      options  : in String := "") return Radiobutton is
   begin -- Create
      return Create (Context, pathName, options);
   end Create;
   ...
   function Create (
      pathName : in String;
      options  : in String := "") return EntryWidget is
   begin -- Create
      return Create (Context, pathName, options);
   end Create;
   ...
   function get (
      Widgt : in EntryWidget) return String is
   begin -- get
   ...
   function Pack_Propagate (
      Master  : in Widget'Class) return Boolean is
   begin -- Pack_Propagate
      Tcl_Eval (Master.Interp, "pack propagate " & Widget_Image (Master));
   ...
   function Pack_Slaves (
      Master  : in Widget'Class) return String is
   begin -- Pack_Slaves
   ...
   begin -- Tk_PathName
      return CHelper.Value (Tcl.Tk.Tk_PathName (
         tkwin));
   end Tk_PathName;
   ...
   begin -- Tk_CanvasTagsPrintProc
      return CHelper.Value (Tcl.Tk.Tk_CanvasTagsPrintProc (
         data,
         tkwin,
         C.Strings.To_Chars_Ptr (C_widgRec'unchecked_access),
         offset,
   ...
   begin -- Tk_DisplayName
      return CHelper.Value (Tcl.Tk.Tk_DisplayName (
         tkwin));
   end Tk_DisplayName;
   ...
   function Tk_GetBinding (
      ...
      C_eventStr : aliased C.Char_Array := C.To_C (eventStr);
   begin -- Tk_GetBinding
      return CHelper.Value (Tcl.Tk.Tk_GetBinding (
         interp,
         bindingTable,
         object,
         C.Strings.To_Chars_Ptr (C_eventStr'unchecked_access)));
   ...
   begin -- Tk_NameOf3DBorder
      return CHelper.Value (Tcl.Tk.Tk_NameOf3DBorder (
         border));
   ...
   begin -- Tk_NameOfAnchor
      return CHelper.Value (Tcl.Tk.Tk_NameOfAnchor (
         anchor));
   end Tk_NameOfAnchor;
   ...
   begin -- Tk_NameOfCapStyle
      return CHelper.Value (Tcl.Tk.Tk_NameOfCapStyle (
         cap));
   ...
   begin -- Tk_NameOfFont
      return CHelper.Value (Tcl.Tk.Tk_NameOfFont (
         font));
   end Tk_NameOfFont;
   ...
   begin -- Tk_NameOfImage
      return CHelper.Value (Tcl.Tk.Tk_NameOfImage (
         imageMaster));
   end Tk_NameOfImage;
   ...
   begin -- Tk_NameOfJoinStyle
      return CHelper.Value (Tcl.Tk.Tk_NameOfJoinStyle (
         join));
   ...
   begin -- Tk_NameOfJustify
      return CHelper.Value (Tcl.Tk.Tk_NameOfJustify (
         justify));
   ...
   begin -- Tk_NameOfRelief
      return CHelper.Value (Tcl.Tk.Tk_NameOfRelief (
         relief));
   end Tk_NameOfRelief;
   ...
   function Tk_SetAppName (
      ...
      C_name : aliased C.Char_Array := C.To_C (name);
   begin -- Tk_SetAppName
      return CHelper.Value (Tcl.Tk.Tk_SetAppName (
         tkwin,
         C.Strings.To_Chars_Ptr (C_name'unchecked_access)));
   end Tk_SetAppName;
