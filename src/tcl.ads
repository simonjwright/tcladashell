...
package Tcl is
   ...
   type Tcl_EncodingFreeProc is access procedure (
      data            : in ClientData
   );
   ...
   type Tcl_NamespaceDeleteProc is access procedure (
      data            : in ClientData
   );
   ...
   type Tcl_DeleteFileHandlerProc is access procedure (
      fd              : in C.Int
   );
   ...
   type Tcl_HashEntry_Array is array (CNatural range <>) of aliased Tcl_HashEntry;
   ...
   type Tcl_SetTimerProc is access procedure (
      timePtr         : in Tcl_Time
   );
   ...
   procedure Tcl_InvalidateStringRep (
      objPtr          : in Tcl_Obj
   );
   ...
   pragma Import (C, Tcl_DeleteCommandFromToken, "Tcl_DeleteCommandFromToken");
   ...
   procedure Tcl_GetEncodingNames (
      interp          : in Tcl_Interp
   );
   ...
   function Tcl_UniCharIsWordChar (
      ch              : in C.Int
   ) return C.Int;
   ...
   function Tcl_Chdir (
      dirName         : in C.Strings.Chars_Ptr
   ) return C.Int;
   ...
   procedure Tcl_SetNotifier (
      notifierProcPtr : in Tcl_NotifierProcs
   );
