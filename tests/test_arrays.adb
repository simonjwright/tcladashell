...
begin -- Test_Arrays
   ...
   begin
      ...
      Tash.Test.Test_Case (
         Description     => "Convert Tash array initialized to Null_Tash_Array to Ada string",
      ...
      Tash.Test.Test_Case (
         Description     => "Get an array element",
         Result          => Tash.Arrays.Get_Element (B, "New York") =
                            "Albany");
      ...
      Tash.Arrays.Set_Element (B, Index => "California", Value => "Sacramento");
      Tash.Test.Test_Case (
      ...
      -----------------------------------------
      Tash.Arrays.Set_Elements (B, Tash.Lists.To_Tash_List (
      ...
      Tash.Test.Test_Case (
         ...
         Result          => Tash.Arrays.Element_Is_String (B, "Empire State Building"));

      Tash.Test.Test_Case (
         Description     => "Element is not a list",
         Result          => not Tash.Arrays.Element_Is_List (B, "Empire State Building"));

      Tash.Test.Test_Case (
         Description     => "Element is not an integer",
         Result          => not Tash.Integer_Arrays.Element_Is_Integer (B, "Empire State Building"));

      Tash.Test.Test_Case (
         Description     => "Element is not a float",
         Result          => not Tash.Float_Arrays.Element_Is_Float (B, "Empire State Building"));
      ...
      Tash.Test.Test_Case (
         Description     => "Get elements of an array whose indices match a pattern",
         Result          => Tash.Lists.To_String(L) =
            "{Faneuil Hall} Boston");
      ...
      L := Tash.Arrays.Get_Sorted_Elements (
              B, Mode => TL.SM_ASCII, Order => TL.Increasing);
      Tash.Test.Test_Case (
      ...
      L := Tash.Arrays.Get_Sorted_Elements (
              B, Mode => TL.SM_ASCII, Order => TL.Decreasing);
      Tash.Test.Test_Case (
         Description     => "Get sorted elements of an array",
         Result          => Tash.Lists.To_String(L) =
            "{Faneuil Hall} Boston {Empire State Building} {New York}");
      ...
      declare
         Description : constant String :=
            "Get an integer element of an uninitialized array -- raise Array_Error";
      begin
         Tash.Test.Test_Case (
            Description     => Description,
      ...
      begin
         Tash.Test.Test_Case (
            Description     => Description,
            Result          => Tash.Integer_Arrays.Get_Element (B, "{Faneuil Hall}") = 0);
         Tash.Test.Test_Case (
            Description     => Description,
            Result          => False);
      exception
      ...
      Tash.Integer_Arrays.Set_Element (
         C, Index => "integer", Value => 100);
      Tash.Test.Test_Case (
         Description     => "Modify existing element -- check length",
      ...
      L := Tash.Arrays.Get_Sorted_Elements (
              C, Mode => TL.SM_ASCII, Order => TL.Decreasing);
      Tash.Test.Test_Case (
         Description     => "Get sorted elements of an array",
         Result          => Tash.Lists.To_String(L) =
      ...
      Tash.Test.Test_Case (
         Description     => "Element is not an integer",
         Result          => not Tash.Integer_Arrays.Element_Is_Integer (C, "float"));
      Tash.Test.Test_Case (
      ...
      declare
         Description : constant String :=
            "Get a float element of an uninitialized array -- raise Array_Error";
      begin
         Tash.Test.Test_Case (
            Description     => Description,
      ...
      begin
         Tash.Test.Test_Case (
            Description     => Description,
            Result          => Tash.Float_Arrays.Get_Element (B, "{Faneuil Hall}") = 0.0);
         Tash.Test.Test_Case (
            Description     => Description,
            Result          => False);
      exception
      ...
      Tash.Float_Arrays.Set_Element (
         C, Index => "float", Value => 100.5);
      Tash.Test.Test_Case (
         Description     => "Modify existing element -- check length",
         Result          => Tash.Arrays.Length(C) = 1);
      Tash.Arrays.Test.Test_Case (
   ...
   if Tash.Test.All_Test_Cases_Passed then
     Ada.Text_IO.Put_Line ("Test_Arrays PASSED --" &
