...
begin --  Test_Regexp
   ...
   begin
      ...
      C := Tash.Integer_Lists.To_Tash_List (52) &
           3.14159 &
           "This is a string" &
           A;
      ...
      Tash.Test.Test_Case
        (Description => "Find 5 going backward",
         Result      =>
           Tash.Regexp.Match_Element (C, "5", Ada.Strings.Backward) = 2);
      ...
      Tash.Test.Test_Case
        (Description => "Basic regular expression match succeeds",
         Result      =>
            Tash.Regexp.Match ("abcccd", "abc*d", Mode => Tash.Regexp.Basic));

      Tash.Test.Test_Case
        (Description => "Basic regular expression match fails",
         Result      =>
           not Tash.Regexp.Match
                 ("abcccd",
                  "abc+d",
                  Mode => Tash.Regexp.Basic));
      ...
      Tash.Test.Test_Case
        (Description => "Quoted regular expression match succeeds",
         Result      =>
            Tash.Regexp.Match ("abcccd", "abc", Mode => Tash.Regexp.Quote));
        ...
        (Description => "Quoted regular expression match fails",
         Result      =>
           not Tash.Regexp.Match
                 ("abcccd",
                  "abc*",
                  Mode => Tash.Regexp.Quote));

      Tash.Test.Test_Case
        (Description =>
           "Advanced, expanded regular expression match succeeds",
         Result      =>
            Tash.Regexp.Match
              ("digits: 012",
               "\d #put comment here!",
      ...
      Tash.Test.Test_Case
        (Description => "Ignore case in regular expression match 1",
         Result      =>
            Tash.Regexp.Match ("ALL CAPS", "all caps", Ignore_Case => True));
      ...
      Tash.Test.Test_Case
        (Description => "Regular expression substitution",
         Result      => Tash.Regexp.Substitute ("abbd", "b+", "ccc") =
                        "acccd");

      Tash.Test.Test_Case
        (Description => "Substitute only first pattern",
         Result      => Tash.Regexp.Substitute ("abbdbbx", "b+", "ccc") =
                        "acccdbbx");

      Tash.Test.Test_Case
        (Description => "Substitute all patterns",
         Result      =>
           Tash.Regexp.Substitute ("abbdbbx", "b+", "ccc", Sub_All => True) =
           "acccdcccx");
