...
begin --  Test_Strings
   ...
   begin
      ...
      Tash.Strings.Test.Test_Case
        ("Convert uninitialized Tash string to Ada string",
         A,
         "",
         0);
      ...
      Tash.Strings.Test.Test_Case
        ("Convert null Tash string to Ada string",
         A,
         "",
         0);
      ...
      A := +"";
      Tash.Strings.Test.Test_Case
        ("Convert empty Ada string to Tash string",
         A,
         "",
         1);
      ...
      A := +"A";
      Tash.Strings.Test.Test_Case
        ("Convert Ada string to Tash string",
         A,
         "A",
         1);
      ...
      Tash.Strings.Test.Test_Case
        ("Append a Tash string to itself",
         A,
         "AA",
         1);
      ...
      Tash.Strings.Test.Test_Case
        ("Append a Tash string to another",
         A,
         "AAB",
         1);
      Tash.Strings.Test.Test_Case
        ("Assure appended string did not change",
         B,
         "B",
         1);
      ...
      Tash.Strings.Test.Test_Case
        ("Append an Ada string to a Tash string",
         A,
         "AABC",
         1);
      ...
      begin
         ...
         Tash.Strings.Test.Test_Case
           ("Append an uninitialized Tash string to itself",
            U,
            "",
            0);
      end;
      ...
      A := +"A";
      Tash.Strings.Test.Test_Case
        ("Concatenate a Tash string with itself",
         A & A,
         "AA",
         1);
      ...
      B := +"B";
      Tash.Strings.Test.Test_Case
        ("Concatenate a Tash string and another",
         A & B,
         "AB",
         1);

      Tash.Strings.Test.Test_Case
        ("Concatenate an Ada string and a Tash string",
         A & "C",
         "AC",
         1);
      Tash.Strings.Test.Test_Case
        ("Concatenate a Tash string and an Ada string",
         "C" & A,
         "CA",
         1);
      ...
      begin
         Tash.Strings.Test.Test_Case
           ("Concatenate an uninitialized Tash string and " &
            "another uninitialized Tash string",
            T & U,
            "",
            0);
      end;
